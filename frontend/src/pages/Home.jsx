...
//   const isSpeakingRef = useRef(false) // ✅ Added
...
//       if (!isSpeakingRef.current && !isRecognizingRef.current) { // ✅ fixed
//         try {
//           recognition.start()
...
//       <button
//         className='min-w-[150px] h-[60px] mt-[30px] text-black font-semibold  
//         bg-white absolute top-[100px] right-[20px] rounded-full cursor-pointer text-[19px] 
//         px-[20px] py-[10px] hidden lg:block'
